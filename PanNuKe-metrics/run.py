...
Usage:
  run.py --true_path=<n> --pred_path=<n> --type_path=<n> --save_path=<n>
  run.py (-h | --help)
  run.py --version
...
Options:
  ...
  --true_path=<n>    Path to ground-truth masks.npy file.
  --pred_path=<n>    Path to prediction masks.npy file.
  --type_path=<n>    Path to types.npy file.
